...
func (r *GameServiceClientRouter) PurchaseCompanionRoute(ctx context.Context, bytes []byte) (socket.Response, error) {
	request, err := protogame.NewPurchaseCompanionRequest(bytes)
	if err != nil {
		return nil, err
	}
...
func (r *GameServiceClientRouter) ClaimAchievementRoute(ctx context.Context, bytes []byte) (socket.Response, error) {
	request, err := protogame.NewClaimAchievementRequest(bytes)
	if err != nil {
		return nil, err
	}
...
func (r *GameServiceClientRouter) ClaimArenaRoute(ctx context.Context, bytes []byte) (socket.Response, error) {
	request, err := protogame.NewArenaClaimRequest(bytes)
	if err != nil {
		return nil, err
	}
